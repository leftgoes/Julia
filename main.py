...
from objects import TestThreading, NoDataException
import functions
...
class Julia:
    def __init__(self, f: Callable, c: complex = None width: int = 640, real: tuple[float, float] = (-2, 2), imag: tuple[float, float] = (-2, 2), max_iterations: int = 30, extra_iterations: int = 2, max_magnitude: float = 2, threads: int = 8, info: bool = True, exponent: int = 2, oversample: int = 1, square_tiling: bool = True, check: bool = False):
        self.f = f
        self.c = c
        self.w = width
